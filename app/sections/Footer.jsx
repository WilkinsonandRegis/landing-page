...
export default function Footer() {
    return (
        <footer className="px-6 mt-12 py-4 border-t dark:border-white/20 border-black/10">
            <div className="flex flex-wrap gap-4 items-center justify-between max-w-[1500px] mx-auto">
