...
export default function HeroSection() {
    return (
        <div className="w-full lg:px-24 max-[940px]:px-12 px-4 sm:pt-56 pt-40 relative" id="top">
            ...
            <div className="dark:hidden h-full w-full absolute top-0 left-0 bg-black/50 pointer-events-none z-[1]"></div>

            <div className="grid sm:grid-cols-2 sm:gap-0 gap-6 grid-cols-1 max-w-[1500px] mx-auto">
